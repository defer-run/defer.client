...
import { enqueueExecution, EnqueueExecutionResponse, waitExecutionResult } from "./client.js";
...
export const delay: DeferDelay =
	(deferFn, delay) =>
		async (...args: Parameters<typeof deferFn>): Promise<UnPromise<ReturnType<DeferRetFn<typeof deferFn>>> | EnqueueExecutionResponse> => {
